...
## Switches
set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 } [get_ports {sel_row[0]}]
set_property -dict { PACKAGE_PIN V16 IOSTANDARD LVCMOS33 } [get_ports {sel_row[1]}]
set_property -dict { PACKAGE_PIN W16 IOSTANDARD LVCMOS33 } [get_ports {sel_row[2]}]
set_property -dict { PACKAGE_PIN W17 IOSTANDARD LVCMOS33 } [get_ports {sel_row[3]}]

set_property -dict { PACKAGE_PIN V15 IOSTANDARD LVCMOS33 } [get_ports {sel_col[0]}]
set_property -dict { PACKAGE_PIN W14 IOSTANDARD LVCMOS33 } [get_ports {sel_col[1]}]
set_property -dict { PACKAGE_PIN W13 IOSTANDARD LVCMOS33 } [get_ports {sel_col[2]}]
set_property -dict { PACKAGE_PIN V2  IOSTANDARD LVCMOS33 } [get_ports {sel_col[3]}]

set_property -dict { PACKAGE_PIN T3 IOSTANDARD LVCMOS33 } [get_ports placing_phase]
set_property -dict { PACKAGE_PIN T2 IOSTANDARD LVCMOS33 } [get_ports active_player]
set_property -dict { PACKAGE_PIN R3 IOSTANDARD LVCMOS33 } [get_ports player_view]
set_property -dict { PACKAGE_PIN W2 IOSTANDARD LVCMOS33 } [get_ports show_blank]

#set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports {sw[12]}]
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports placing_mode]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports confirm_switch]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports view_switch]
...
set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports fire_pulse]
